<template>
    ...
    <div class="m-5">
        <table class="table-auto w-full text-base text-left text-gray-800 dark:text-gray-400 text-center">
            ...
            <tbody>
                <tr v-for="device in this.devicesData" :key="device.id"
                    ...
                    <td class="px-4 py-4 text-center align-middle">
                        <button class="bg-red-600 hover:bg-red-500 text-white font-bold py-2 px-2 ml-2 rounded ">
